...
def ArcFaceModel(size=None,
                 ...
                 training=False):
    """Arc Face Model"""
    x = images = Input([size, size, channels], name='input_image')
    labels = Input([num_classes], name='label')
    ...
    if training:
        ...
        return Model((images, labels), logist, name=name)
    else:
        return Model(images, embds, name=name)
